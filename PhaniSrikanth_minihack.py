...
train = pd.read_csv("train_63qYitG.csv"); train.shape
test = pd.read_csv("test_XaoFywY.csv"); test.shape
...
test.Confidence_Life_Style_Index.value_counts(dropna=False)
...
print(submit.Surge_Pricing_Type.value_counts())
submit.head()
